...
import { supabase } from "@/lib/supabase/client"; // Import your Supabase client instance
import toast from "react-hot-toast";
import { useUser } from "./useUser";

interface UseUploadFilesReturnType {
  selectedFiles: FileType | null;
  isLoading: boolean;
  handleFilesChange: (event: ChangeEvent<HTMLInputElement>) => Promise<void>;
  resetFiles: () => void;
  setSelectedFiles: (file: FileType | null) => void;
}

const useUploadFiles = (): UseUploadFilesReturnType => {
  ...
  const getCompressedFile = async (file: File): Promise<File> => {
