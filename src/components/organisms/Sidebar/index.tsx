...
const Sidebar = () => {
  ...
  return (
    <aside
      className={cn(
        "right-sidebar transition-all flex flex-col fixed inset-0 !z-[110] w-full lg:sticky top-0 bottom-0 lg:max-w-64",
        open
        ...
        >
          <button onClick={handleClick}>
            {open ? (
              ...
              // />
              <>
                <div className="w-[137px] opacity-0 h-[60px] relative"> {/*//TODO/*/}
