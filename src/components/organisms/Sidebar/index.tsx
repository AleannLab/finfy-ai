...
const Sidebar = () => {
  ...
  return (
    <aside
      className={cn(
        "right-sidebar transition-all flex flex-col fixed inset-0 !z-[201] !max-h-[100%] w-full lg:sticky top-0 bottom-0 md:max-w-64",
        open
    ...
    >
      <div className="px-2 flex flex-col">
            ...
            {open ? (
              ...
              <>
                <div className="w-[169px] h-9 relative">
                  {/* <div className="w-[110px] left-[38px] top-[10px] absolute text-[#666] text-base font-semibold leading-none">Espen</div>
                  <Icon type="LogoIcon" /> */}
        ...
        {/* <Button
          ...
          >
            ...
            <span
              className={cn("text-base text-grey-15 group-hover:text-[#666]", {
                "lg:hidden": !open,
              })}
            >
              New Thread
      ...
      <div className="mt-auto">
        ...
        {/* <Button
          full
          className={cn(
            "justify-start items-center text-xs font-semibold border-t border-t-navy-5 text-[#666] p-6 !rounded-none",
            {
              "lg:hidden": !open,
            }
          )}
