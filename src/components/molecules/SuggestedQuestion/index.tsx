...
const SuggestedQuestion: FC<SuggestedQuestionProps> = ({ question }) => {
  ...
  return (
    <button
      onClick={handleClick}
      className="border flex-1 min-w-72 max-w-72 h-16 flex justify-start text-start items-start text-[#473513] text-xs md:text-sm bg-navy-15 rounded-md p-2 md:p-3 border-navy-5"
    >
